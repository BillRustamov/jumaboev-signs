...
const SAMPLE_NAME: Record<string, Record<ShopLang, string>> = {
  ...
  "logo-spotlight": {
    ...
    uz: "Oq logo bilan",
    tg: "Сафед бо лого",
    ru: "Белый с логотипом",
    kk: "Ақ, логотиппен",
    ky: "Ак, логотип менен",
    uk: "Білий з логотипом",
  },
  "white-minimal": {
    en: "White Minimal",
    uz: "Oq minimal",
    tg: "Сафеди минималӣ",
    ru: "Белый минимальный",
    kk: "Ақ минимал",
    ky: "Ак минималдуу",
    uk: "Білий мінімальний",
  },
  "white-premium": {
    en: "White Premium Accent",
    uz: "Oq premium aksent",
    tg: "Сафеди премиум",
    ru: "Белый премиум",
    kk: "Ақ премиум",
    ky: "Ак премиум",
...
const SAMPLE_HINT: Record<string, Record<ShopLang, string>> = {
  ...
  "logo-spotlight": {
    en: "20 × 12 in · logo on top, locked USDOT and MC",
    uz: "20 × 12 dyuym · logo yuqorida, USDOT va MC qulflangan",
    tg: "20 × 12 дюйм · лого боло, USDOT ва MC қулф",
    ru: "20 × 12 дюймов · логотип сверху, USDOT и MC зафиксированы",
    kk: "20 × 12 дюйм · логотип жоғарыда, USDOT пен MC бекітілген",
    ky: "20 × 12 дюйм · логотип үстүндө, USDOT жана MC кулпуланган",
    uk: "20 × 12 дюймів · логотип зверху, USDOT і MC зафіксовані",
  },
  "white-minimal": {
    en: "20 × 12 in · larger DOT and MC, little decoration",
    uz: "20 × 12 dyuym · kattaroq DOT va MC, kam bezak",
    tg: "20 × 12 дюйм · DOT ва MC калонтар, ороиши кам",
    ru: "20 × 12 дюймов · крупнее DOT и MC, мало декора",
    kk: "20 × 12 дюйм · үлкенірек DOT және MC, аз әшекей",
    ky: "20 × 12 дюйм · чоңураак DOT жана MC, аз кооздук",
    uk: "20 × 12 дюймів · більші DOT і MC, мало декору",
  },
  "white-premium": {
    en: "20 × 12 in · gold rule and border on white vinyl",
    uz: "20 × 12 dyuym · oq vinilda oltin chiziq va chegara",
    tg: "20 × 12 дюйм · хати тилло ва марз дар винили сафед",
    ru: "20 × 12 дюймов · золотая линия и рамка на белом виниле",
    kk: "20 × 12 дюйм · ақ винилде алтын сызық пен жиек",
    ky: "20 × 12 дюйм · ак винилде алтын сызык жана чек",
    uk: "20 × 12 дюймів · золота лінія і рамка на білому вінілі",
  },
  "side-by-side": {
...
const PRESET_NAME: Record<string, Record<ShopLang, string>> = {
  ...
  "white-green": {
    en: "Dark green lettering",
    uz: "To‘q yashil yozuv",
    tg: "Навиштаи сабзи торик",
    ru: "Тёмно-зелёная надпись",
    kk: "Қою жасыл жазу",
    ky: "Кочкул жашыл жазуу",
    uk: "Темно-зелений напис",
  },
  "white-red": {
    en: "Red lettering",
    uz: "Qizil yozuv",
  ...
  "white-black-red": {
    en: "Black + red accent",
    uz: "Qora + qizil aksent",
    tg: "Сиёҳ + аксенти сурх",
    ru: "Чёрный + красный акцент",
    kk: "Қара + қызыл акцент",
    ky: "Кара + кызыл акцент",
    uk: "Чорний + червоний акцент",
  },
  "white-navy-red": {
    en: "Navy + red accent",
    uz: "To‘q ko‘k + qizil aksent",
    tg: "Тӯсӣ + аксенти сурх",
    ru: "Синий + красный акцент",
    kk: "Қою көк + қызыл акцент",
    ky: "Кочкул көк + кызыл акцент",
    uk: "Синій + червоний акцент",
  },
  "cut-black": {
    en: "Cut black",
    uz: "Kesilgan qora",
...
const PRESET_HINT: Record<string, Record<ShopLang, string>> = {
  ...
  "white-green": {
    en: "White vinyl · forest type",
    uz: "Oq vinil · to‘q yashil yozuv",
    tg: "Винили сафед · ҳуруфи сабзи торик",
    ru: "Белый винил · тёмно-зелёный шрифт",
    kk: "Ақ винил · қою жасыл жазу",
    ky: "Ак винил · кочкул жашыл жазуу",
    uk: "Білий вініл · темно-зелений шрифт",
  },
  "white-black-red": {
    en: "White vinyl · black type · red rules",
    uz: "Oq vinil · qora yozuv · qizil chiziqlar",
    tg: "Винили сафед · ҳуруфи сиёҳ · хатҳои сурх",
    ru: "Белый винил · чёрный шрифт · красные линии",
    kk: "Ақ винил · қара жазу · қызыл сызықтар",
    ky: "Ак винил · кара жазуу · кызыл сызыктар",
    uk: "Білий вініл · чорний шрифт · червоні лінії",
  },
  "white-navy-red": {
    en: "White vinyl · navy type · red rules",
    uz: "Oq vinil · to‘q ko‘k yozuv · qizil chiziqlar",
    tg: "Винили сафед · ҳуруфи тӯсӣ · хатҳои сурх",
    ru: "Белый винил · синий шрифт · красные линии",
    kk: "Ақ винил · қою көк жазу · қызыл сызықтар",
    ky: "Ак винил · кочкул көк жазуу · кызыл сызыктар",
    uk: "Білий вініл · синій шрифт · червоні лінії",
  },
  "white-gold": {
...
const NOTE_EXACT: Record<string, UiKey> = {
  ...
  "Reduced the logo so USDOT and MC stay at a readable size.": "noteReducedLogo",
  ...
  "Logo was reduced so USDOT and MC stay at a readable size. Try a smaller logo or wrap the company name.":
    "noteReducedLogoHint",
  "Logo is small on this layout. Increase size or pick White with Logo.": "noteLogoSmall",
  ...
  "Payment status is not set by hand. Paid is set only from a verified Stripe webhook.":
    "noteHandPaid",
  "Enter a valid email.": "noteEmailInvalid",
  "Password must be at least 8 characters.": "notePasswordShort",
  "An account with this email already exists.": "noteAccountExists",
  "Email or password is wrong.": "noteAccountWrong",
  "Too many sign-in attempts. Wait a few minutes.": "noteTooManyAuth",
  "Too many account attempts. Wait a few minutes.": "noteTooManyAuth",
